...
Try {
    ...
    [string]$appVendor = 'CCSB'
    [string]$appName = 'AutoDock Vina'
    [string]$appVersion = '1.1.2'
    [string]$appArch = 'x86'
    [string]$appLang = 'EN'
    [string]$appRevision = '01'
    [string]$appScriptVersion = '1.0.0'
    [string]$appScriptDate = '08/16/2023'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-MSI -Action "Install" -Path "autodock_vina_1_1_2_win32.msi" -Parameters "ALLUSERS=1 REBOOT=ReallySuppress /QN" -PassThru
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Execute-MSI -Action "Uninstall" -Path "autodock_vina_1_1_2_win32.msi" -PassThru
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB9cTcIR7pHFSJG
# t2CvFs2LE76HI3Bs9/+yFu05cA9OQaCCH8AwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDHbXPlCK8it5vP
# Lxn47ln5hGpZHWjBtmwDpjfzXyNHEDANBgkqhkiG9w0BAQEFAASCAYCZLz0ladTC
# dsTBRqqSPON2p6T6BLyH3IAIU3lrcSKDnn8TogSeQSCjAsWjCZBPi6P3DmYuM2EX
# mh76JAAlZDJTLQLrqF+xVcPiEtCi4WMEFltKQVbZVyCfMWvf1VAet1A/d1sb2pYK
# A/4w5xDimdwESe/2yw0sUDL5kptB2taqQsH070W2oBy0NlNQu1ExtsIoQ5Yqr5WU
# XnrtF0awaxkSSJq++UMpKhjUNus0ljdKLuBEmiYeMeNxB0ni4CXGPfo8s1R4DTF3
# Kr+gIcJRijpWVYU+7v4VlCYBvJxHLg1NEnI7MTte/ZbuslpFQv7sdHMhIPYxNNoi
# 2SNVpLXofype22nS3A0r/e9P3BsF4j1/DE5cWjw9XmtOCDByIK4uzEUUYJOyJ7MP
# WSd5oLcR8TeN6YCoEng0OxEU26rZGUzGDHaZlqEOoUCYnoTy3XQyL8BVxqGdo/Kx
# wsvXALl6AvqfqO+rVeZigf1Rsro6wLropa5RWBaxLu/S3UFp4meFBZKhggNLMIID
...
# KoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwODE2MTYx
# NzI1WjA/BgkqhkiG9w0BCQQxMgQwOtpGYy8F0mIHs0yfqRCuWNfb0RngVFbyNPNX
# neAAHuQvuNNnBtWcy5LyUHws2HcGMA0GCSqGSIb3DQEBAQUABIICAFioyb4SYrtv
# rvBkVzHrOGmn7kDXkeZglGNFN1rp3fuAjsGow0AjUlcU6dVE4WGFcYMfIfAE5/W0
# FLjZUaM7XQLPw0D6PewqkAhA/rDZL6Nf+ebWBVcPymRcYVFgzM+sCOjTP0wGYk3S
# /d+xVIVIbrpKMfspr0yLYI3TXCreP/cK8qzRT7HUILVlggN1HlBn3vlHqg2bNWgi
# orGI+r4LoZYQup0mYTaiW6EQRu29fe+6rTzTIM0dmuW1ZAYJPb2yP/WBvRKATOZD
# JaZJdynpLr36s3nCol8FQhb+FoCTAyHZsV/tMIltMl2klkrufUXKJPmHNDhnfKGK
# 45SzzHmih1W2w/Q9IJt1lOwLpDMGp0nAlJ/2DMYLDx7fNBWPii4V4lO3kifTZCqX
# N/OY4KACNyZF/1tvVlIJnumvH/6avFMg3Mzf05gE4IKY8TNms0CH2nA+KE778fW/
# lRCC6aPlyJ5E+y4TqgJnhUWe5CvAy6KjSnkm6Frv/y4QKFDC/Hu821Aoh8LRuEjI
# DrcZPVObZmiVYft49ZAKKpf0L9R4VPcFJcMtW+Edi8Q6PrTvmj9lea2hRYUNwhQo
# RmXUuf0dbo8xll4oK7ikKXkbBPnJJV/HbZQdOBDhtcFAw9Qyxf2mtUmR9whxm3KF
# v1JG2giqNt1ANz/4sRVL+XENTW70cjnY
